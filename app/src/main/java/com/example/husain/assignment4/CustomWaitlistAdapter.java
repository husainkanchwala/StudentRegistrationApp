...
public class CustomWaitlistAdapter extends BaseAdapter {
    private Activity activity;
    private LayoutInflater inflater;
    private List<CourseData> courseItems;

    public CustomWaitlistAdapter(Activity activity, List<CourseData> courseItem) {
    ...
    public View getView(int position, View convertView, final ViewGroup parent) {
        ...
        buttonRegister.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
             UnRegisterUserInWaitlist user = new UnRegisterUserInWaitlist();
