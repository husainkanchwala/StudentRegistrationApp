...
import static com.example.husain.assignment4.MainActivity.PREFERENCES;

/**
 * Created by husain on 4/1/2018.
 */

public class RegisterUserInClass {

    public String urlToSendSubject = "https://bismarck.sdsu.edu/registration/registerclass";
    SharedPreferences sharedPreferences;
    public static final String PREFERENCES = "PreferencesInfo";

    public void register(String id, final Context context){
